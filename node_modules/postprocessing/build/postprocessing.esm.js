...
import {BasicDepthPacking as BasicDepthPacking3} from "three";
...
var EffectComposer = class {
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    ...
    const options = {
      format: !alpha && type === UnsignedByteType4 ? RGBFormat4 : RGBAFormat3,
...
var DepthOfFieldEffect = class extends Effect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    this.blurPass.initialize(renderer, alpha, UnsignedByteType6);
    if (!alpha && frameBufferType === UnsignedByteType6) {
...
var NoiseTexture = class extends DataTexture {
  constructor(width, height, format = LuminanceFormat2, type = UnsignedByteType7) {
...
var GodRaysEffect = class extends Effect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (!alpha && frameBufferType === UnsignedByteType8) {
...
var SelectiveBloomEffect = class extends BloomEffect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    this.depthPass.initialize(renderer, alpha, frameBufferType);
    this.depthMaskPass.initialize(renderer, alpha, frameBufferType);
    if (!alpha && frameBufferType === UnsignedByteType11) {
...
import {LinearEncoding as LinearEncoding3, Matrix3, sRGBEncoding as sRGBEncoding3, Uniform as Uniform41} from "three";
